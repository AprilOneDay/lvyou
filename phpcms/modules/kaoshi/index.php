...
class index
{
    ...
    public function xfsh()
    {
        if ($_GET['type'] == 'ysh') {
            header('location:/admin/xfsh_ysh.php');
        }
        if ($_GET['type'] == 'wsh') {
            header('location:/admin/xfsh_wsh.php');
        }
    }
    public function kj()
    {
    ...
    {
        if ($_GET['type'] == 'zftj') {
            header('location:/frame/index.php?m=console&c=credit&a=lists_all');
            //header('location:/admin/xftj_zftj.php');
        }
        if ($_GET['type'] == 'mxtj') {
            header('location:/frame/index.php?m=console&c=credit&a=lists');
    ...
    public function fxm()
    {
        ...
        if ($_GET['type'] == 'xm_list') {
            header('location:/admin/xm_list.php');
        }
    }
