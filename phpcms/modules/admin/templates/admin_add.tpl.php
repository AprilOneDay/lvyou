...
$(function(){
	...
	$("#username").formValidator({onshow:"<?php echo L('input').L('username')?>",onfocus:"<?php echo L('username').L('between_2_to_20')?>"}).inputValidator({min:2,max:200,onerror:"<?php echo L('username').L('between_2_to_20')?>"}).ajaxValidator({
	    type : "get",
		url : "",
