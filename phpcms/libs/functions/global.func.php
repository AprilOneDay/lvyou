...
function wd_pages($num, $curr_page, $perpage = 20, $urlrule = '', $array = array(), $setpages = 10)
{
    /*if (defined('URLRULE') && $urlrule == '') {
    $urlrule = URLRULE;
    $array   = $GLOBALS['URL_ARRAY'];
    ...
    if ($num > $perpage) {
        ...
        $multipage .= '<li><a class="a1">' . $num . L('page_item') . '</a></li>';
        if ($curr_page > 0) {
            $multipage .= '<li><a href="' . pageurl($urlrule, $curr_page - 1, $array) . '" class="a1">' . L('previous') . '</a><li>';
            if ($curr_page == 1) {
                $multipage .= '<li><a href="javascript:;"> 1</a> </li>';
            } elseif ($curr_page > 6 && $more) {
        ...
        for ($i = $from; $i <= $to; $i++) {
            if ($i != $curr_page) {
                ...
                $multipage .= ' <li><a href="javascript:;">' . $i . '</a></li>';
            }
        }
        if ($curr_page < $pages) {
            if ($curr_page < $pages - 5 && $more) {
            ...
            $multipage .= ' <li><a href="javascript:;">' . $pages . '</a> </li><li>  <a href="' . pageurl($urlrule, $curr_page, $array) . '" class="a1">' . L('next') . '</a></li>';
        } else {
            $multipage .= ' <li><a href="' . pageurl($urlrule, $pages, $array) . '">' . $pages . '</a></li><li> <a href="' . pageurl($urlrule, $curr_page + 1, $array) . '" class="a1">' . L('next') . '</a></li>';
        }
    }
