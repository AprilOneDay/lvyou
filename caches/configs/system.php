...
'upload_url' => 'http://lvyou.loc/uploadfile/', //附件路径

'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担



'js_path' => 'http://lvyou.loc/statics/js/', //CDN JS

'css_path' => 'http://lvyou.loc/statics/css/', //CDN CSS

'img_path' => 'http://lvyou.loc/statics/images/', //CDN img

'app_path' => 'http://lvyou.loc/',//动态域名配置地址
