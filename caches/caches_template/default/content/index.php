...
<script type="text/javascript">
    ...
    var content = '<div style="margin:0;line-height:20px;padding:2px;">' +
                    '<img src="/images/bg1.png" alt="" style="float:right;zoom:1;overflow:hidden;width:100px;height:100px;margin-left:3px;"/>' +
    ...
    var marker = new BMap.Marker(new BMap.Point(113.10423,22.840355),{icon:myIcon}); //创建marker对象
